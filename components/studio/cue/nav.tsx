...
const navItems = [
  { href: '/apps/cue', label: 'Dashboard', exact: true },
  { href: '/apps/cue/pulse', label: 'Pulse' },
  { href: '/apps/cue/contacts', label: 'Contacts' },
  { href: '/apps/cue/profile', label: 'Profile' },
]

export function CueNav() {
