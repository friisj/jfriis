 ...
 *   - "generations"   → images generated via generate_image tool
 *   - "studies"       → images generated by chassis study pipeline
 *   - "sketches"      → pencil sketch studies via Flux 2 Dev
 *   - "references"    → curated canonical reference images
 *   - "uploads"       → user-uploaded images from chat conversations
...
function luvSeriesDescription(key: string): string {
  ...
  if (key === 'references') return 'Curated canonical reference images for Luv character consistency';
  if (key === 'uploads') return 'Images uploaded by the user during chat conversations';
  if (key === 'generations') return 'Images generated by Luv agent via generate_image tool';
  ...
  if (key === 'videos') return 'Videos generated by Luv agent via start_video_generation tool';
