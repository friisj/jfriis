...
import { Ball, type BallPhysicsState, type TerrainHeightfield } from "@/components/studio/putt/ball";
...
/**
 * Spike 1b.2: Basic Physics Validation
 *
 * Simple plane with adjustable slope to validate core ball physics
 * before testing on complex green terrain.
 */
...
export default function PhysicsBasicPage() {
  ...
  const launchBall = () => {
    ...
    console.log("\n📊 PHYSICS MODEL:");
    console.log("  • 2D surface-constrained simulation (ball pinned to terrain)");
    console.log("  • NO vertical gravity (no falling through)");
    console.log("  • Force = -m*g*∇h (component of gravity along slope)");
    console.log("  • Ball Y-position set explicitly each frame: Y = terrainHeight + radius");
    console.log("  • heightAboveTerrain should always equal ball radius (0.0214m)");
    console.log("=".repeat(80));
  };
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="border-b p-3 text-sm bg-muted/50 flex items-center justify-between">
          <div className="flex gap-6">
            <div>
              <span className="font-semibold">Purpose:</span> Validate ball physics on controllable plane before complex terrain
            </div>
          </div>
