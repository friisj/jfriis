...
import DesignSystemConfiguratorPrototype from '../_components/design-system-configurator-prototype'

const prototypeComponents: Record<string, React.ComponentType> = {
  'design-system-configurator': DesignSystemConfiguratorPrototype,
}
...
export default async function ExperimentPage({ params }: Props) {
  ...
  const PrototypeComponent = experiment.type === 'prototype'
    ? prototypeComponents[experimentSlug]
    : null
